        ...
        <div className="main-container">
          ...
          <div className="sub-container">
            ...
            <div className="right-sub-container">
              <p>Current values</p>
              <Graphind text={'Temperature 1'} color={"#df0000"} curval={maindata[0].temperature1}/>
              <Graphind text={'Temperature 2'} color={"#00bf00"} curval={maindata[0].temperature2}/>
              <Graphind text={'Temperature 3'} color={"#0000df"} curval={maindata[0].temperature3}/>
            </div>
          </div>
        </div>
      </div>
